...
namespace Đồ_án_ltwin
{
    class MEMBER
    {
        ...
        public string totalFPTStore()
        {
            return execCount("SELECT COUNT(*) FROM std WHERE fname='FPT'");
        }
        public string totalTGDD()
        {
            return execCount("SELECT COUNT(*) FROM std WHERE fname='TGDD'");
        }
        public string totalPhongvu()
        {
            return execCount("SELECT COUNT(*) FROM std WHERE fname='Phong Vu'");
        }
        public string totalDMX()
        {
            return execCount("SELECT COUNT(*) FROM std WHERE fname='DMX'");
        }

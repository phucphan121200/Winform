...
namespace Đồ_án_ltwin
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void frmHoaDon_Load(object sender, EventArgs e)
        {
            ...
            Functions.FillCombo("SELECT id, lname FROM Login", cboManhanvien, "id", "Tenkhach");
        ...
        private void LoadInfoHoadon()
        {
            ...
            str = "SELECT id FROM tblHDBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan, Ngayban, id, Makhach, Tongtien) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
        ...
        private void cboManhanvien_TextChanged(object sender, EventArgs e)
        {
            ...
            str = "Select lname from Login where id =N'" + cboManhanvien.SelectedValue + "'";
        ...
        private void btnInhoadon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "CÔNG TY MÁY TÍNH ORWELL";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "1st Vo Van Ngan, Linh Chieu, District Thu Duc, TPHCM";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: (+84)944707505";
            ...
            sql = "SELECT a.MaHDBan, a.Ngayban, a.Tongtien, b.Tenkhach, b.Diachi, b.Dienthoai, c.lname FROM tblHDBan AS a, tblKhach AS b, Login AS c WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' AND a.Makhach = b.Makhach AND a.id = c.id";
